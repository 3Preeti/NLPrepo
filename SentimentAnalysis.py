...
#Amazon data
input_file = r'C:\Users\Preeti Sunar\Downloads\sentiment+labelled+sentences\sentiment labelled sentences\amazon_cells_labelled.txt'
amazon = pd.read_csv(input_file, delimiter='\t', header=None)
amazon.columns = ['Sentence', 'Class']

#Yelp data
input_file = r'C:\Users\Preeti Sunar\Downloads\sentiment+labelled+sentences\sentiment labelled sentences\yelp_labelled.txt'
yelp = pd.read_csv(input_file, delimiter='\t', header=None)
yelp.columns = ['Sentence', 'Class']

#IMDB data
input_file = r'C:\Users\Preeti Sunar\Downloads\sentiment+labelled+sentences\sentiment labelled sentences\imdb_labelled.txt'
